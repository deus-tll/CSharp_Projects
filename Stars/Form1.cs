...
namespace Stars
{
	public partial class Form1 : Form
	{
		...
		private void DrawStar(Star star)
		{
			...
			float x = Map(star.X / star.Z, 0,(float)0.8,0, pictureBox1.Width) + pictureBox1.Width / 2;
			float y = Map(star.Y / star.Z, 0, (float)0.8,0,pictureBox1.Height) + pictureBox1.Height / 2;
